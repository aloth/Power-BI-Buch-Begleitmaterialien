...
1️⃣ **Power BI Desktop installieren** (kostenlos): [Download](https://powerbi.microsoft.com/de-de/desktop/)

2️⃣ **Dateien herunterladen**

* **Einfach:** `Code` → `Download ZIP` → entpacken → `.pbix`-Dateien öffnen
* **Fortgeschritten:**

```bash
git clone https://github.com/aloth/Power-BI-Buch-Begleitmaterialien.git
```
...
* **Verbesserungen beitragen:** Pull Request willkommen – besonders zu branchenspezifischen Beispielen.
